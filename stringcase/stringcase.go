...
// ToSnakeCase converts characters to snake_case
...
// ToPascalCase converts characters to Pascal naming/CamelCase (CamelCase)
func ToPascalCase(input string) string {
	return toCamelCase(input, true)
}

// ToLowCamelCase converts characters to lower camel case (lowerCamelCase)
